  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      >
        <ThemeProvider>
          {/* Header */}
          <header className="sticky top-0 z-50 border-b border-[var(--card-border)]/70 bg-[var(--background)]/85 text-[var(--foreground)] backdrop-blur-md">
            <div className="h-0.5 bg-gradient-to-r from-[var(--karate-green)] via-[var(--karate-yellow)] to-[var(--karate-green)]" />
            <div className="container mx-auto px-4 py-3">
              <div className="flex items-center justify-between rounded-2xl border border-[var(--card-border)]/60 bg-[var(--card-bg)]/80 px-3 py-2 clean-shadow">
          ...
          <footer className="bg-[var(--background)]/90 text-[var(--foreground)] py-12 mt-auto border-t border-[var(--card-border)]/70">
            <div className="container mx-auto px-4">
              <div className="rounded-3xl border border-[var(--card-border)]/60 bg-[var(--card-bg)]/70 backdrop-blur-sm px-6 py-7 md:px-8 clean-shadow">
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                
                {/* Brand & Copyright */}
                <div className="flex flex-col items-center md:items-start gap-2">
                  <div className="flex items-center gap-3">
                    <div className="relative w-9 h-9 bg-white rounded-full p-0.5 overflow-hidden border border-[var(--karate-yellow)]/60">
                      <Image src="/logo.png" alt="Shorin Kai Logo" fill className="object-cover" />
                    </div>
                ...
                {/* Contact & Links */}
                <div className="flex flex-col md:flex-row items-center gap-3 text-sm text-[var(--muted)]">
                  <a href="mailto:contact@shorinkai.in" className="hover:text-[var(--karate-green)] transition-colors inline-flex items-center gap-2 rounded-full border border-[var(--card-border)]/60 bg-[var(--background)]/70 px-3 py-1.5">
                  ...
                  <a 
                    ...
                    className="hover:text-[var(--foreground)] transition-colors inline-flex items-center gap-2 rounded-full border border-[var(--card-border)]/60 bg-[var(--background)]/70 px-3 py-1.5"
                  >
