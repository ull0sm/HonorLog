        ...
        <section className="panel p-6 sm:p-8">
            <div className="flex flex-wrap items-start justify-between gap-4">
                <div className="max-w-2xl">
                    ...
                    <p className="mt-3 text-sm leading-7 text-muted-foreground sm:text-base">
                        Monitor event state, import readiness, and result lock status from one table.
                    </p>
                </div>
            ...
            {error ? (
                ...
                <div className="mt-6 rounded-3xl border border-dashed border-border bg-background/60 px-5 py-6 text-sm text-muted-foreground">
                    No events are available yet. Create your first event to begin portal operations.
                </div>
            ) : (
                            ...
                            <div className="divide-y divide-border/70">
                                {eventRows.map((event) => (
                                    <Link
                                        ...
                                        className="grid grid-cols-[minmax(0,2.3fr)_minmax(0,1.1fr)_minmax(0,0.9fr)_minmax(0,0.9fr)] gap-4 px-4 py-4 transition-colors hover:bg-background/50"
                                    >
                                        <div>
